...
class ExperienceBuffer:
    ...
    def add_experience(
        ...
        self.priorities = np_append(self.priorities, self.max_priority**self.alpha)
    ...
    def sample(
        ...
        # for batches, np.power(x, y, dtype=float32) is faster than np.array(x**y, dtype=float32)
