...
def plot():
    ...
    plt.rc('axes', labelsize=15)  # fontsize of the axes labels in pt, default: 10
    plt.rc('xtick', labelsize=15)  # fontsize of the x tick labels in pt, default: 10
    plt.rc('ytick', labelsize=15)  # fontsize of the y tick labels in pt, default: 10
    plt.rc('legend', fontsize=15)  # fontsize of the legend in pt, default: 10
    ...
    plot_name = 'paper_results_status_report'
    fig, ax = plt.subplots(
        nrows=2, ncols=2,
    ...
    # ])
    generic_plot_beautify()
    # ax[axis].set_xlim([0.9, 1.04])
    ax[axis].set_xlabel('Fehler')
