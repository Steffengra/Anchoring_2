...
def plot():
    ...
    plot_contents = {
        ...
        'Aug 0.2': cnt_cfg.contents_aug20,
        # 'Aug 0.5': cnt_cfg.contents_aug50,
        'GEM K=2^9': cnt_cfg.contents_gem512,
        'GEM K=2^13': cnt_cfg.contents_gem8138,
        # 'GEM K=2^15': cnt_cfg.contents_gem32768,
        'GEM K=2^16': cnt_cfg.contents_gem65536,
        'EWC w=1e-5': cnt_cfg.contents_ewce5,
        'EWC w=1e-6': cnt_cfg.contents_ewce6,
        'EWC w=1e-7': cnt_cfg.contents_ewce7,
    }
    ...
    ax[axis].set_xlabel('Avg. $r_{TO,t}$')
